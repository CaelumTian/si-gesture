    ...
    var Handler = {
        ...
        touchMove: function touchMove(event) {
            for (var i = 0, len = event.changedTouches.length; i < len; i++) {
                ...
                //移动距离
                var distanceX = touch.clientX - gesture.startTouch.clientX,
            ...
            if (Object.keys(gestures).length === 2) {
                ...
                for (var _i = 0, _len = event.touches.length; _i < _len; _i++) {
                    ...
                    startPosition.push([_gesture.startTouch.clientX, _gesture.startTouch.clientY]);
            ...
            for (var i = 0, len = event.changedTouches.length; i < len; i++) {
                ...
                if (gesture.status === "panning") {
                    ...
                    var duration = now - gesture.startTime,
                        ...
                        distanceY = touch.clientY - gesture.startTouch.clientY;
                    var velocity = Math.sqrt(Math.pow(gesture.velocityY, 2) + Math.pow(gesture.velocityX, 2));
